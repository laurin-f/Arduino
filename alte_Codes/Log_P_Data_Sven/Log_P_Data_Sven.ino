...
void loop() {
  ...
  if (add_mill < 10){
    snprintf(msg, 75, "%s;%d;%d;%d;%d;%d;%d;%d-%d-%d %d:%d:%d.%d", logger, analog_0, analog_1, analog_2, analog_3, analog_6, analog_7, year_str, month_str, day_str, hour_str, minute_str, second_str, add_mill); 
    Serial.println(msg);
